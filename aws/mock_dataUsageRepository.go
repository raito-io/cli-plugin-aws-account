...
func (_m *mockDataUsageRepository) ListFiles(ctx context.Context, configMap *config.ConfigMap, bucket string, prefix *string) ([]AwsS3Entity, error) {
...
//   - bucket string
//   - prefix *string
func (_e *mockDataUsageRepository_Expecter) ListFiles(ctx interface{}, configMap interface{}, bucket interface{}, prefix interface{}) *mockDataUsageRepository_ListFiles_Call {
	return &mockDataUsageRepository_ListFiles_Call{Call: _e.mock.On("ListFiles", ctx, configMap, bucket, prefix)}
}

func (_c *mockDataUsageRepository_ListFiles_Call) Run(run func(ctx context.Context, configMap *config.ConfigMap, bucket string, prefix *string)) *mockDataUsageRepository_ListFiles_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockDataUsageRepository_ListFiles_Call) RunAndReturn(run func(context.Context, *config.ConfigMap, string, *string) ([]AwsS3Entity, error)) *mockDataUsageRepository_ListFiles_Call {
	_c.Call.Return(run)
	return _c
}
