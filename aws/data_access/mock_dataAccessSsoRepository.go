...
func (_m *MockdataAccessSsoRepository) CreateSsoRole(ctx context.Context, name string, description string, tags map[string]string) (string, error) {
	ret := _m.Called(ctx, name, description, tags)
...
func (_e *MockdataAccessSsoRepository_Expecter) CreateSsoRole(ctx interface{}, name interface{}, description interface{}, tags interface{}) *MockdataAccessSsoRepository_CreateSsoRole_Call {
	return &MockdataAccessSsoRepository_CreateSsoRole_Call{Call: _e.mock.On("CreateSsoRole", ctx, name, description, tags)}
}

func (_c *MockdataAccessSsoRepository_CreateSsoRole_Call) Run(run func(ctx context.Context, name string, description string, tags map[string]string)) *MockdataAccessSsoRepository_CreateSsoRole_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockdataAccessSsoRepository_CreateSsoRole_Call) RunAndReturn(run func(context.Context, string, string, map[string]string) (string, error)) *MockdataAccessSsoRepository_CreateSsoRole_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
func (_e *MockdataAccessSsoRepository_Expecter) ListSsoRoles(ctx interface{}) *MockdataAccessSsoRepository_ListSsoRoles_Call {
	return &MockdataAccessSsoRepository_ListSsoRoles_Call{Call: _e.mock.On("ListSsoRoles", ctx)}
}

func (_c *MockdataAccessSsoRepository_ListSsoRoles_Call) Run(run func(ctx context.Context)) *MockdataAccessSsoRepository_ListSsoRoles_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockdataAccessSsoRepository_ListSsoRoles_Call) Return(_a0 []string, _a1 error) *MockdataAccessSsoRepository_ListSsoRoles_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockdataAccessSsoRepository_ListSsoRoles_Call) RunAndReturn(run func(context.Context) ([]string, error)) *MockdataAccessSsoRepository_ListSsoRoles_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockdataAccessSsoRepository) ProvisionPermissionSetAndWait(ctx context.Context, permissionSetArn string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ProvisionPermissionSetAndWait")
	}
...
func (_e *MockdataAccessSsoRepository_Expecter) ProvisionPermissionSetAndWait(ctx interface{}, permissionSetArn interface{}) *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call {
	return &MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call{Call: _e.mock.On("ProvisionPermissionSetAndWait", ctx, permissionSetArn)}
}

func (_c *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call) Run(run func(ctx context.Context, permissionSetArn string)) *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call) Return(_a0 error) *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call) RunAndReturn(run func(context.Context, string) error) *MockdataAccessSsoRepository_ProvisionPermissionSetAndWait_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockdataAccessSsoRepository) UpdateInlinePolicyToPermissionSet(ctx context.Context, permissionSetArn string, statements []*policy.Statement) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []*policy.Statement) error); ok {
...
func (_c *MockdataAccessSsoRepository_UpdateInlinePolicyToPermissionSet_Call) Run(run func(ctx context.Context, permissionSetArn string, statements []*policy.Statement)) *MockdataAccessSsoRepository_UpdateInlinePolicyToPermissionSet_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockdataAccessSsoRepository_UpdateInlinePolicyToPermissionSet_Call) RunAndReturn(run func(context.Context, string, []*policy.Statement) error) *MockdataAccessSsoRepository_UpdateInlinePolicyToPermissionSet_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockdataAccessSsoRepository) UpdateSsoRole(ctx context.Context, arn string, description string, tags map[string]string) error {
	ret := _m.Called(ctx, arn, description, tags)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, map[string]string) error); ok {
		r0 = rf(ctx, arn, description, tags)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockdataAccessSsoRepository_Expecter) UpdateSsoRole(ctx interface{}, arn interface{}, description interface{}, tags interface{}) *MockdataAccessSsoRepository_UpdateSsoRole_Call {
	return &MockdataAccessSsoRepository_UpdateSsoRole_Call{Call: _e.mock.On("UpdateSsoRole", ctx, arn, description, tags)}
}

func (_c *MockdataAccessSsoRepository_UpdateSsoRole_Call) Run(run func(ctx context.Context, arn string, description string, tags map[string]string)) *MockdataAccessSsoRepository_UpdateSsoRole_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(map[string]string))
	})
	return _c
...
func (_c *MockdataAccessSsoRepository_UpdateSsoRole_Call) RunAndReturn(run func(context.Context, string, string, map[string]string) error) *MockdataAccessSsoRepository_UpdateSsoRole_Call {
	_c.Call.Return(run)
	return _c
}
