...
// GetSsoRoleWithPrefix provides a mock function with given fields: ctx, prefixName
func (_m *MockdataAccessRepository) GetSsoRoleWithPrefix(ctx context.Context, prefixName string) (*model.RoleEntity, error) {
	ret := _m.Called(ctx, prefixName)
...
//   - ctx context.Context
//   - prefixName string
func (_e *MockdataAccessRepository_Expecter) GetSsoRoleWithPrefix(ctx interface{}, prefixName interface{}) *MockdataAccessRepository_GetSsoRoleWithPrefix_Call {
	return &MockdataAccessRepository_GetSsoRoleWithPrefix_Call{Call: _e.mock.On("GetSsoRoleWithPrefix", ctx, prefixName)}
}

func (_c *MockdataAccessRepository_GetSsoRoleWithPrefix_Call) Run(run func(ctx context.Context, prefixName string)) *MockdataAccessRepository_GetSsoRoleWithPrefix_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockdataAccessRepository_GetSsoRoleWithPrefix_Call) RunAndReturn(run func(context.Context, string) (*model.RoleEntity, error)) *MockdataAccessRepository_GetSsoRoleWithPrefix_Call {
	_c.Call.Return(run)
	return _c
}
