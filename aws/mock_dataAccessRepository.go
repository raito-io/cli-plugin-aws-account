...
func (_m *mockDataAccessRepository) GetManagedPolicies(ctx context.Context) ([]PolicyEntity, error) {
	ret := _m.Called(ctx)

	var r0 []PolicyEntity
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]PolicyEntity, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []PolicyEntity); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *mockDataAccessRepository_GetManagedPolicies_Call) RunAndReturn(run func(context.Context) ([]PolicyEntity, error)) *mockDataAccessRepository_GetManagedPolicies_Call {
	_c.Call.Return(run)
	return _c
}
