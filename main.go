		...
		wrappers.DataUsageSync(usage.NewDataUsageSyncer()), &info.InfoImpl{
			Info: &plugin.PluginInfo{
				...
				Parameters: []*plugin.ParameterInfo{
					...
					{Name: constants.AwsAccessSsoRolePrefix, Description: "Optional prefix for Permission Sets generated by the connector. Note: permission sets currently cannot be renamed, so adding/updating this parameter later will not update existing permission sets.", Mandatory: false},
					{Name: constants.AwsAccessSsoRoleSuffix, Description: "Optional suffix for Permission Sets generated by the connector. Note: permissions sets currently cannot be renamed, so adding/updating this parameter later will not update existing permission sets.", Mandatory: false},
