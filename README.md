...
- `aws-s3-include-buckets` (optional): Comma-separated list of buckets to include. If specified, only these buckets will be handled. Regular expressions can be used (e.g. 'dev-.*,test-bucket').
- `aws-s3-exclude-buckets` (optional): Comma-separated list of buckets to exclude. If specified, these buckets will not be handled. Regular expressions can be used (e.g. 'prod-.*,legacy-bucket'). Excludes have preference over includes.
...
| `aws-s3-include-buckets`                        | Comma-separated list of buckets to include. If specified, only these buckets will be handled. Regular expressions can be used (e.g. 'dev-.*,test-bucket').                                                                                                                                                                                                                     | False     | `*`              |
| `aws-s3-exclude-buckets`                        | Comma-separated list of buckets to exclude. If specified, these buckets will not be handled. Regular expressions can be used (e.g. 'prod-.*,legacy-bucket'). Excludes have preference over includes.                                                                                                                                                                               | False     |                  |
...
| `aws-glue-exclude-databases`                    | Optional comma-separated list of Glue databases to exclude. If specified, these databases (and all their tables) will not be handled. Regular expressions can be used (e.g. 'test-db-*,prod-db').                                                                                                                                                                         | False     |                  |
| `aws-glue-exclude-tables`                       | Optional comma-separated list of Glue tables to exclude. If specified, these tables will not be handled. Regular expressions can be used (e.g. 'temp-.*,sensitive-table'). This applies to all databases that are not excluded.                                                                                                                                                           | False     |                  |
...
| `aws-permissionset-dummy-user`             | Optional dummy user to use for permission sets that are not associated with any user or group yet. A permission set in AWS cannot be provisioned to an AWS account when no users are assigned to it, so this user will be assigned to avoid this situation to make sure that the provisioned permission set can be referenced by other Access Controls.                                                                                                                                                                                              | False     |                  |
